 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    ...
                    <?php
                           ...
                           $PhotosID="img/".basename($_FILES["PhotosID"]["name"]);
...
// Check if image file is a actual image or fake image
  ...
  $check = getimagesize($_FILES["PhotosID"]["tmp_name"]);
  if($check !== false) {
    echo "Thank you for uploading Image " . $check["mime"] . ".";
    $uploadOk = 1;
  } else {
    echo "File is not an image.";
    $uploadOk = 0;
  }
 (move_uploaded_file($_FILES["PhotosID"]["tmp_name"], $target_file)) 
?>