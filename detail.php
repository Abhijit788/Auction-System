...
<head>
    ...
    <meta name="description" content="Bid Mate">
    ...
    <script>
function abc(){
 var a = document.getElementById("count2").innerHTML;
 
 if (a=="Auction Ended !")
 {
	 document.getElementById("bidValue").style.display = "none";
	 
	 document.getElementById("bidValue1").style.display = "none";
	 
	 document.getElementById("bidValue2").style.display = "none";
 }
}
function sub()
{
    alert("sub");
    window.location.href ="http://razorpay.com/payment-links/";
...
<body  onload="countdown(year,month,day,hour,minute);abc()">
...
$db1 = mysqli_connect('localhost','root','','shop');
 ...
 $query1 = "SELECT * FROM bids Where ItemID=$ItemNo";
...
<h3>Total Bids:<?php echo $count1 ?></h3>
                                ...
                                <p class="price">Current Bid : Rs <?php echo  number_format($row['CurrentPrice'],2);?></p>
                                 ...
                                 <form action="" method="post" align="center">
									    ...
									    <input type="number" id="bidValue" name="bidValue" /><br><br>


									<p id="bidValue2"  align="center">Enter a value greater than Rs <?php echo number_format($leastValue,2);?> </p>
<?php if($_SESSION['userid'] != $row['SellerID']){?>
									    <input class="btn btn-primary" id="bidValue1" type="submit" align="center" value="Bid Now" ><br/><br>
									<?php }?></form>
								...
								<div style="color:red" align="center" >
									...
									<?php 
										function updater($value,$id,$leastValue,$ExpectedValue,$userID){
										    ...
										    if ( $value > $leastValue && $db->query($sql) == TRUE) {
