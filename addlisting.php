...
<?php 
                    ...
                    <div class="box" id="contact">
                        ...
                        <form class="form-horizontal"enctype="multipart/form-data" action="success.php" method="POST">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <label class="control-label col-sm-2" >Description:</label>
                                         <div class="col-sm-10">
                                        <textarea class="form-control" min="20" rows="5" name="Description" required></textarea>
                                        <br>
                                        </div>
                                    
                                    <label class="control-label col-sm-2" >Images :</label>
                                         <div class="col-sm-10">
                                       <input type="file" class="form-control" name="PhotosID" placeholder="Enter the image URL Eg: img/image.jpg">
                                       <br>
                                        </div>
						...
						3. Prices and Time period
                                ...
                                <div id="collapseThree" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <label class="control-label col-sm-2" >Minmum Price:</label>
                                         <div class="col-sm-10">
                                       <input type="number" class="form-control" name="StartingPrice" placeholder="Enter the Minmum Value in Rupees">
                                       <br>
                                        </div>

                                          <input type="text" class="form-control" style="display:none"  value="10000"name="ExpectedPrice" placeholder="Enter the Expected Value in Rupees">
                                       <br>
                                        </div>
